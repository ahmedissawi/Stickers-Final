...
struct Interoperability {
    ...
    static func send(json: [String: Any]) -> Bool {
        ...
        jsonWithAppStoreLink["ios_app_store_link"] = "https://itunes.apple.com/app/id1462045333?mt=8"
        jsonWithAppStoreLink["android_play_store_link"] = "https://play.google.com/store/apps/details?id=com.imNMSH.StickerFree"
